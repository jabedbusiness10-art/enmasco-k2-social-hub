...
export const contentPlans: ContentPlan[] = [
  {
    ...
    creatorId: "u2",
    assigneeId: "u2",
    media: [{ id: "m1", type: "IMAGE", url: "", alt: "Eid sale banner" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u2",
    media: [{ id: "m2", type: "VIDEO", url: "", alt: "Security tips reel" }],
  ...
  },
  {
    ...
    creatorId: "u3",
    assigneeId: "u3",
    media: [{ id: "m3", type: "IMAGE", url: "", alt: "Hiring post" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u4",
    media: [{ id: "m4", type: "VIDEO", url: "", alt: "Launch teaser" }],
  ...
  },
  {
    ...
    creatorId: "u2",
    assigneeId: "u2",
    media: [{ id: "m5", type: "CAROUSEL", url: "", alt: "Weekly deals" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u4",
    media: [{ id: "m6", type: "VIDEO", url: "", alt: "Behind the brand" }],
  ...
  },
  {
    ...
    creatorId: "u5",
    assigneeId: "u5",
    media: [{ id: "m7", type: "IMAGE", url: "", alt: "Case study" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u4",
    media: [{ id: "m8", type: "IMAGE", url: "", alt: "Eid greeting" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u2",
    media: [{ id: "m9", type: "VIDEO", url: "", alt: "Unboxing" }],
  ...
  },
  {
    ...
    creatorId: "u3",
    assigneeId: "u3",
    media: [{ id: "m10", type: "IMAGE", url: "", alt: "Webinar" }],
  ...
  },
  {
    ...
    creatorId: "u4",
    assigneeId: "u4",
    media: [{ id: "m11", type: "VIDEO", url: "", alt: "Trend soundbyte" }],
