...
const SCHEMA: { key: string; required: boolean; note?: string }[] = [
  ...
  { key: "AI_PROVIDER", required: false, note: "AI provider id (recommended: openai)." },
  { key: "OPENAI_API_KEY", required: false, note: "Server-only OpenAI project key for K2Kai AI." },
  ...
  { key: "LINKEDIN_REDIRECT_URI", required: false, note: "Exact LinkedIn OAuth callback URL." },
  { key: "LINKEDIN_SCOPES", required: false, note: "Only scopes approved in the LinkedIn Developer Portal." },
  { key: "LINKEDIN_API_VERSION", required: false, note: "LinkedIn Marketing API version (YYYYMM)." },
