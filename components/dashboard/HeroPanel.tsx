...
const quickActions = [
  ...
  { icon: MessageCircle, label: "K2 MESSENGER", href: "/messenger" },
...
export default function HeroPanel({ className = "" }: HeroPanelProps) {
  return (
    <motion.section
      ...
      className={`enterprise-hero-panel relative isolate min-h-full overflow-hidden rounded-[28px] border border-white/10 bg-[#09090b]/80 p-5 text-white shadow-[0_28px_90px_rgba(0,0,0,0.36)] backdrop-blur-2xl sm:p-6 lg:p-7 ${className}`}
    >
