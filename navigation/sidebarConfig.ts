...
export const sidebarConfig: NavSection[] = [
  ...
  },
  {
    ...
    label: "Users",
    icon: Users,
    href: "/dashboard/admin/security/permissions",
    crumb: "Users",
    expandable: true,
    children: [
      { label: "User Management", href: "/dashboard/admin/security/permissions", description: "Manage platform users, access, and invitations." },
