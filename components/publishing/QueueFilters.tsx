  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-3">
      ...
      <div className="mt-2 space-y-2">
        ...
        <select className="h-8 w-full rounded-lg border border-white/10 bg-white/5 px-2 text-xs text-white outline-none"><option>Status</option><option>Queued</option><option>Published</option><option>Failed</option></select>
        <select className="h-8 w-full rounded-lg border border-white/10 bg-white/5 px-2 text-xs text-white outline-none"><option>Campaign</option><option>Eid</option><option>Security</option></select>
