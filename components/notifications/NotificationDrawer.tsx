    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="fixed right-0 top-0 flex h-[100vh] w-[420px] max-w-[92vw] flex-col border-l border-white/10 bg-[#0e0f17] shadow-2xl"
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 px-4 py-3">
            ...
            <div className="flex items-center gap-1">
              <button onClick={markAll} className="flex items-center gap-1 rounded-lg border border-white/10 px-2 py-1 text-[11px] text-white/70 hover:bg-white/5">
              ...
              <AnimatePresence>
                {items.map((n) => (
                  ...
                  >
                    ...
                    {!n.isRead && (
                      <button onClick={() => markRead(n.id)} className="self-center rounded-lg border border-white/10 p-1.5 text-sky-300 hover:bg-white/5" aria-label="Mark read">
