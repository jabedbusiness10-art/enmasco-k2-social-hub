...
export function SecurityStat({ label, value, icon: Icon = Shield, tone = "blue", hint }: StatProps) {
  const ring = {
    green: "border-emerald-400/20", yellow: "border-amber-400/20", red: "border-rose-400/20",
    blue: "border-sky-400/20", gray: "border-white/10",
  }[tone];
  return (
    <AnimatedCard>
